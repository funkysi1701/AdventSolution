...
namespace Advent
{
    public class day8
    {
        public string[] input = new string[300] { "qxfcsmh",
...
"njro\x68qgbx\xe4af\"\\suan"	,
        ...
        public string[] input2 = new string[4] { "",
        "abc",
        "aaa\"aaa",
        "\x27"};
        public int total = 0;
        ...
        public int actualLength(string input)
        {
            ...
            for (int i = 0; i < input.Length; i++)
            {
                if (input.Substring(i, 1) == escape1) { count++; length = length + 2; }
                if (input.Substring(i, 1) == escape2) { count++; length = length + 2; }
                //if (input.Substring(i, 1) == escape3) count++;
            }
